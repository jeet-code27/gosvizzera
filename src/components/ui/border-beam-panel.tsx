...
/* Border Beam Panel — with original vibrant dual-comet colors & crystal-clear text readability */

const MOTIQ_TOKENS = `
@layer motiq {
  :root {
    --motiq-accent: #315fea;
    --motiq-accent-text: #244fd1;
    --motiq-bg: #ffffff;
    --motiq-border: #e2e8f0;
    --motiq-border-strong: #cbd5e1;
    --motiq-fg: #0f172a;
    --motiq-fg-secondary: #475569;
    --motiq-muted: #64748b;
    --motiq-secondary-accent: #009fb3;
    --motiq-signature: #e9564a;
    --motiq-surface: #ffffff;
    --motiq-surface-2: #f8fafc;
  }
  .dark, [data-theme="dark"] {
    ...
    --motiq-muted: #94a3b8;
    --motiq-secondary-accent: #22c7d9;
    --motiq-signature: #ff6b5e;
    --motiq-surface: #0f172a;
    --motiq-surface-2: #192337;
  }
}
`.trim();
...
.${cls} .mk-beam-glow { filter: blur(12px); opacity: 0.22; z-index: -1; }
@media (forced-colors: active) {
  ...
  return (
    <div
      ...
      onBlur={settle}
      className={cn(
        "relative w-full border border-slate-200/90 dark:border-slate-800/90 bg-white dark:bg-slate-900 p-6 sm:p-7 transition-all duration-300 shadow-sm hover:shadow-xl dark:shadow-black/40",
        cls,
        className,
      )}
      style={{
